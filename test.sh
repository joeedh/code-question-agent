...
pnpm testagent worktest3 --goal "create a 3d rts game (think through the gameplay and strategy) with good looking buildings and units, verify over cdp with screenshots; write the source code in more then one file with a good source tree layout"
